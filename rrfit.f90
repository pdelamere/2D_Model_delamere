...
!***  MODIFIED FOR FORTRAN 90 by Matthew Copper May 15, 2013
...
!******************************************************************************
      real rrec(2,30,30),rnew(4,30,30),fe(3,13),tt,r
      double precision   ::t
      integer iz,in, i
      logical stuff1, stuff2
...
!      common/ferr/fe(3,13)
      ...
      if(in.lt.1.or.in.gt.iz)then
         write(6,'('' rrfit called with insane number elec ='',i4)') in
        stop
      endif
      stuff1=in.le.3.or.in.eq.11.or.(iz.gt.5.and.iz.lt.9) 
      stuff2=iz.eq.10.or.(iz.eq.26.and.in.gt.11)
      if(stuff1.or.stuff2)then         
